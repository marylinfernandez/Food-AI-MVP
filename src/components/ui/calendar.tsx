  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // CABECERAS: Grid de 7 columnas forzado
        weekdays: "grid grid-cols-7 w-full bg-black dark:bg-zinc-900 border-b border-white/10",
        weekday: "text-white font-bold text-[0.6rem] uppercase h-14 w-full flex items-center justify-center border-r border-white/10 last:border-r-0",
        weeks: "w-full block",
        // FILAS: Grid de 7 columnas forzado para coincidir con cabeceras
